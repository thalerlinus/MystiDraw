            ...
            <tr>
                ...
                <td style="width: 45%; vertical-align: top;">
                    ...
                    @if($payment->order->billing_address)
                        {!! nl2br(e($payment->order->billing_address)) !!}
                    @endif
                </td>
        ...
        <table class="nobrd">
            <thead>
                <tr style="color: #000000;">
                    <th style="width: 8%; color: black; border: none; padding: 8px; text-align: left;">Pos.</th>
                    <th style="width: 52%; color: black; text-align: left; border: none; padding: 8px;">Beschreibung</th>
                    <th style="width: 12%; color: black; text-align: center; border: none; padding: 8px;">Anzahl</th>
                    <th style="width: 14%; color: black; text-align: right; border: none; padding: 8px;">Einzelpreis</th>
                    <th style="width: 14%; color: black; text-align: right; border: none; padding: 8px;">Gesamtpreis</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($payment->order->items as $index => $item)
                    <tr style="border-bottom: 1px solid #1e3a8a;">
                        <td style="width: 8%; padding: 8px;">{{ $index + 1 }}</td>
                        <td style="width: 52%; padding: 8px;">
                            <strong>{{ $item->raffle->name ?? 'Raffle' }} - Raffle Lose</strong><br>
                            <small style="color: #64748b;">
                                Lose für Raffle: {{ $item->raffle->name ?? 'N/A' }}<br>
                                Kategorie: {{ $item->raffle->category->name ?? 'Allgemein' }}
                            </small>
                        </td>
                        <td style="width: 12%; padding: 8px; text-align: center;">
                            {{ $item->quantity }} Lose
                        </td>
                        <td style="width: 14%; padding: 8px; text-align: right;">
