                ...
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <div class="grid md:grid-cols-3 gap-8 mb-12">
                        <div class="text-center">
                            ...
                            <p class="text-gray-600">support@mystidraw.de</p>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Support-Zeiten</h3>
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Standort</h3>
                            <p class="text-gray-600">Deutschland</p>
                        </div>
                    </div>
                    
                    <div class="bg-gray-50 rounded-2xl p-8">
                        <h3 class="text-2xl font-semibold text-gray-900 mb-4">Häufige Fragen</h3>
                        <div class="space-y-4 text-left">
                            <div>
                                <h4 class="font-semibold text-gray-900">Wie funktioniert das Inventar-System?</h4>
                                <p class="text-gray-600 mt-1">Du sammelst deine Gewinne in deinem digitalen Inventar und kannst sie später als Paket versenden lassen.</p>
                            </div>
                            <div>
                                <h4 class="font-semibold text-gray-900">Wann erhalte ich meinen Gewinn?</h4>
                                <p class="text-gray-600 mt-1">Sofort nach dem Kauf erfährst du deinen Gewinn. Der Versand erfolgt auf Anfrage aus deinem Inventar.</p>
                            </div>
                            <div>
                                <h4 class="font-semibold text-gray-900">Ist der Versand kostenlos?</h4>
                                <p class="text-gray-600 mt-1">Ja, der Versand ist innerhalb Deutschlands komplett kostenlos!</p>
                            </div>
                        </div>
                    </div>
                </div>
