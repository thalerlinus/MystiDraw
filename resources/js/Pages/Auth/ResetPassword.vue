...
<template>
    <MainLayout title="Passwort zurücksetzen" :show-footer="false">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-navy-200/20">
                        ...
                        <div class="text-center mb-8">
                            <div class="w-16 h-16 bg-gold-gradient rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <font-awesome-icon :icon="['fas', 'lock']" class="text-2xl text-navy-900" />
                            </div>
                            <h1 class="text-3xl font-bold text-navy-900 mb-2">Neues Passwort</h1>
                            <p class="text-navy-600">Erstelle ein sicheres neues Passwort für dein Konto</p>
                        </div>
                        ...
                        <div class="mt-8 text-center">
                            <Link
                                :href="route('login')"
                                class="font-semibold text-gold-600 hover:text-gold-500 transition-colors"
                            >
