                ...
                <div class="w-full max-w-md">
                    <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-navy-200/20">
                        ...
                        <div class="text-center mb-8">
                            <h1 class="text-3xl font-bold text-navy-900 mb-2">Willkommen zurück!</h1>
                            <p class="text-navy-600">Melde dich an und entdecke neue Gewinne</p>
                        </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center group">
                                    <Checkbox name="remember" v-model:checked="form.remember" class="rounded border-navy-300 focus:ring-gold-400/20" />
                                    <span class="ml-2 text-sm text-navy-600 group-hover:text-navy-700 transition-colors">
                                        Angemeldet bleiben
                                    </span>
                                </label>
                                ...
                                <Link
                                    ...
                                    class="text-sm text-gold-600 hover:text-gold-500 font-medium transition-colors"
                                >
                                    Passwort vergessen?
                                </Link>
                            </div>
