...
<template>
    <MainLayout title="E-Mail bestätigen" :show-footer="false">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-navy-200/20">
                        ...
                        <div class="text-center mb-8">
                            <div class="w-16 h-16 bg-gold-gradient rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <font-awesome-icon :icon="['fas', 'envelope-circle-check']" class="text-2xl text-navy-900" />
                            </div>
                            <h1 class="text-3xl font-bold text-navy-900 mb-2">E-Mail bestätigen</h1>
                            <p class="text-navy-600">Wir haben dir eine Bestätigungs-E-Mail gesendet</p>
                        </div>
                        ...
                        <!-- Success Message -->
                        <div v-if="verificationLinkSent" class="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-2xl">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            <div class="flex flex-col space-y-4">
                                ...
                                <Link
                                    ...
                                    method="post"
                                    as="button"
                                    class="w-full px-6 py-3 border-2 border-navy-300 text-navy-700 font-semibold rounded-xl hover:bg-navy-50 hover:border-navy-400 transition-all duration-300 text-center"
                                >
                        ...
                        <div class="mt-8 text-center">
                            <p class="text-xs text-navy-500 leading-relaxed">
                                Keine E-Mail erhalten? Überprüfe deinen Spam-Ordner oder fordere eine neue an.
                            </p>
                        </div>
                    </div>
                </div>
