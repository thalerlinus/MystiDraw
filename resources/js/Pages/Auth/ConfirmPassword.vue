...
<template>
    <MainLayout title="Passwort bestätigen" :show-footer="false">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-navy-200/20">
                        ...
                        <div class="text-center mb-8">
                            <div class="w-16 h-16 bg-gold-gradient rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <font-awesome-icon :icon="['fas', 'shield-check']" class="text-2xl text-navy-900" />
                            </div>
                            <h1 class="text-3xl font-bold text-navy-900 mb-2">Passwort bestätigen</h1>
                            <p class="text-navy-600">Sicherheitsbereich - Passwort erforderlich</p>
                        </div>

                        <!-- Description -->
                        <div class="mb-6 p-4 bg-navy-50 rounded-2xl border border-navy-100">
                            <p class="text-sm text-navy-600 text-center">
                                Dies ist ein sicherer Bereich der Anwendung. Bitte bestätige dein Passwort, um fortzufahren.
                            </p>
                        </div>
